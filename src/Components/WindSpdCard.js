            ...
            <div className="">
                    ...
                    <div className="d-flex mt-2 justify-content-between">
                        ...
                        <div className="d-flex flex-column justify-content-center ">
                            ...
                            <button data-toggle="tooltip" data-placement="top" title="refers to the fraction of the sky obscured by clouds when observed from a particular location" className="border-bottom border-2 border-warning clr-31 fw-bold text-decoration-none">Clouds: <span className="clr-4">{props.cloudIndex}</span></button>
                            <button data-toggle="tooltip" data-placement="top" title="Air quality is a measure of how clean or polluted the air is" className="border-bottom border-2 border-warning clr-31 fw-bold text-decoration-none">Air Quality: <span className="clr-4">{props.airQuality}</span></button>
                        </div>
                    </div>
